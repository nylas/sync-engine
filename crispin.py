...
class Mail():
    ...
    def list_folders(self):
        ...
        try:
            resp = self.server.xlist_folders()
        except Exception, e:
            raise e
    ...
    def create_draft(self, message_string):
        ...
        self.server.append("[Gmail]/Drafts",
    ...
    def fetch_headers(self, folder_name):
        ...
        messages = self.server.fetch(UIDs, [query, 'X-GM-THRID'])
...
if __name__ == "__main__":
    ...
    for f in folders:
        ...
        print f['flags']
        print "    " + f['name'] + '...', 
        print str(m.message_count(f['name']))
