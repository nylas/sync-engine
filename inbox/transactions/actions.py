...
from inbox.models import SpoolMessage, Tag, Thread, Transaction
from inbox.actions import (mark_read, mark_unread, archive, unarchive, star,
                           unstar, save_draft, delete_draft)
            ...
            for transaction in query:
                ...
                if transaction.table_name == 'spoolmessage':
                    ...
                    if transaction.command == 'insert':
                        ...
                        self._execute_async_action(delete_draft, account_id,
                                                   message.inbox_uid)
                    continue
                ...
                for tag_id in added_tag_ids:
                    ...
                    for action in self.actions.on_apply(tag.public_id):
                        self._execute_async_action(action, account_id,
                                                   thread.id)
