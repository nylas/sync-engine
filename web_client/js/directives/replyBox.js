...
app.directive("composebox", function() {
    return {
        ...
        template: '<div class="compose_to_bar" style="margin-left: 5px; background-color: rgba(1,1,1,0.15); padding-bottom:30px;">' +

        'To: <div class="compose_addressbox">' + '<form><input ng-model="query" ng-change="update()" type="text" class="mysearchbox" placeholder="" ></form>' + '</div>' +

        '</div>' +



        '<div id="reply_box" ng-style="container_style">' + '<div ng-style="reply_box_style" class="card_with_shadow">' +
